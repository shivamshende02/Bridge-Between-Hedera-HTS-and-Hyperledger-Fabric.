...
export default class TokenAllowance {
     ...
     * @returns {TokenAllowance}
     */
    static _fromGrantedProtobuf(allowance: proto.IGrantedTokenAllowance): TokenAllowance;
    /**
     * @internal
     * @param {object} props
...
export namespace proto {
    ...
    type IGrantedTokenAllowance = import("@hashgraph/proto").IGrantedTokenAllowance;
